...
def test__get_s3_client_errors(mock_boto_client):
    ...
    mock_boto_client.return_value.head_bucket.side_effect = NoCredentialsError()
    ...
    mock_boto_client.return_value.head_bucket.assert_called_once_with(Bucket='bucket_name')
